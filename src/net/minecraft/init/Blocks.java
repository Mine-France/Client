...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        blockRegistry.addObject(50, "torch", (new BlockTorch()).setHardness(0.0F).setLightLevel(0.8F).setStepSound(soundTypeWood).setBlockName("torch").setBlockTextureName("torch_on"));
        ...
        //------------------------------------------------------------//
        blockRegistry.addObject(4000, "argent_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("argent_ore").setBlockTextureName("argent_ore"));
        blockRegistry.addObject(4001, "argent_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("argent_block").setBlockTextureName("argent_block"));
        blockRegistry.addObject(4002, "cuivre_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("cuivre_ore").setBlockTextureName("cuivre_ore"));
        blockRegistry.addObject(4003, "cuivre_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("cuivre_block").setBlockTextureName("cuivre_block"));
        blockRegistry.addObject(4004, "cinabre_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("cinabre_ore").setBlockTextureName("cinabre_ore"));
        blockRegistry.addObject(4005, "cinabre_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("cinabre_block").setBlockTextureName("cinabre_block"));
        blockRegistry.addObject(4006, "bournonite_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("bournonite_ore").setBlockTextureName("bournonite_ore"));
        blockRegistry.addObject(4007, "bournonite_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("bournonite_block").setBlockTextureName("bournonite_block"));
        blockRegistry.addObject(4008, "azurite_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("azurite_ore").setBlockTextureName("azurite_ore"));
        blockRegistry.addObject(4009, "azurite_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("azurite_block").setBlockTextureName("azurite_block"));
        //------------------------------------------------------------//
