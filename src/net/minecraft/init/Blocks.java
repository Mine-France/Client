...
public class Blocks
{
    ...
    //------------------------------------------------------------//
    public static final Block paradis_ore = (Block)Block.blockRegistry.getObject("paradis_ore");
    public static final Block paradis_block = (Block)Block.blockRegistry.getObject("paradis_block");
    //------------------------------------------------------------//
