...
public class CraftingManager
{
    ...
    private static final String __OBFID = "CL_00000090";CraftingManager
    ...
    private CraftingManager()
    {
        ...
        this.addRecipe(new ItemStack(Items.bread_dough, 1), new Object[] {"###", '#', Items.wheat});
        ...
        this.addRecipe(new ItemStack(Items.gold_bread, 1), new Object[] {"#", "X", '#', Items.gold_nugget, 'X', Items.bread});
        this.addRecipe(new ItemStack(Items.slice_bread, 2), new Object[] {"#", '#', Items.bread});
        
        this.addRecipe(new ItemStack(Items.sandwich_cheese, 1), new Object[] {"A", "B", "C", 'A', Items.slice_bread, 'B', Items.cheese, 'C', Items.slice_bread});
        this.addRecipe(new ItemStack(Items.sandwich_chicken, 1), new Object[] {"A", "B", "C", 'A', Items.slice_bread, 'B', Items.cooked_chicken, 'C', Items.slice_bread});
        this.addRecipe(new ItemStack(Items.sandwich_bacon, 1), new Object[] {"A", "B", "C", 'A', Items.slice_bread, 'B', Items.cooked_bacon, 'C', Items.slice_bread});
        this.addRecipe(new ItemStack(Items.sandwich_ham, 1), new Object[] {"A", "B", "C", 'A', Items.slice_bread, 'B', Items.porkchop, 'C', Items.slice_bread});
        this.addRecipe(new ItemStack(Items.sandwich_fish, 1), new Object[] {"A", "B", "C", 'A', Items.slice_bread, 'B', Items.cooked_fished, 'C', Items.slice_bread});
        this.addRecipe(new ItemStack(Items.cheese, 1), new Object[] {"#", '#', Items.bucket_cheese});
        
        this.addRecipe(new ItemStack(Items.skewered_meat, 1), new Object[] {"A", "B", "C", 'A', Items.cooked_fished, 'B', Items.cooked_porkchop, 'C', Items.stick});
        this.addRecipe(new ItemStack(Items.raw_bacon, 1), new Object[] {"#", '#', Items.porkchop});
        this.addRecipe(new ItemStack(Items.mashed_potato, 1), new Object[] {"A", "B", "C", 'A', Items.baked_potato, 'B', Items.baked_potato, 'C', Items.bowl});
        this.addRecipe(new ItemStack(Items.vegetable_soup, 1), new Object[] {"A", "B", "C", 'A', Items.carrot, 'B', Items.baked_potato, 'C', Items.bowl});
        this.addRecipe(new ItemStack(Items.fish_soup, 1), new Object[] {"A", "B", 'A', Items.cooked_fished, 'B', Items.bowl});
        this.addRecipe(new ItemStack(Items.pumpkin_soup, 1), new Object[] {"A", "B", 'A', Blocks.pumpkin, 'B', Items.bowl});
        
        this.addRecipe(new ItemStack(Items.purse_bag_empty, 1), new Object[] {"LSL", "L L", "LLL", 'L', Items.leather, 'S', Items.string});
        this.addRecipe(new ItemStack(Items.purse_bag_8g, 1), new Object[] {"OOO", "OPO", "OOO", 'O', Items.coin_gold, 'P', Items.purse_bag_empty});
        this.addRecipe(new ItemStack(Items.purse_bag_16g, 1), new Object[] {"OOO", "OPO", "OOO", 'O', Items.coin_gold, 'P', Items.purse_bag_8g});
        this.addRecipe(new ItemStack(Items.purse_bag_24g, 1), new Object[] {"OOO", "OPO", "OOO", 'O', Items.coin_gold, 'P', Items.purse_bag_16g});
        this.addRecipe(new ItemStack(Items.purse_bag_32g, 1), new Object[] {"OOO", "OPO", "OOO", 'O', Items.coin_gold, 'P', Items.purse_bag_24g});
        
        this.addShapelessRecipe(new ItemStack(Items.coin_gold, 8), new Object[] {Items.purse_bag_8g});
        this.addShapelessRecipe(new ItemStack(Items.coin_gold, 16), new Object[] {Items.purse_bag_16g});
        this.addShapelessRecipe(new ItemStack(Items.coin_gold, 24), new Object[] {Items.purse_bag_24g});
        this.addShapelessRecipe(new ItemStack(Items.coin_gold, 32), new Object[] {Items.purse_bag_32g});
        
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_16g, 1), new Object[] {Items.purse_bag_8g, Items.purse_bag_8g});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_24g, 1), new Object[] {Items.purse_bag_8g, Items.purse_bag_8g, Items.purse_bag_8g});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_32g, 1), new Object[] {Items.purse_bag_8g, Items.purse_bag_8g, Items.purse_bag_8g, Items.purse_bag_8g});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_24g, 1), new Object[] {Items.purse_bag_8g, Items.purse_bag_16g});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_32g, 1), new Object[] {Items.purse_bag_8g, Items.purse_bag_8g, Items.purse_bag_16g});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_32g, 1), new Object[] {Items.purse_bag_16g, Items.purse_bag_16g});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_32g, 1), new Object[] {Items.purse_bag_8g, Items.purse_bag_24g});
        
        this.addRecipe(new ItemStack(Items.purse_bag_8s, 1), new Object[] {"OOO", "OPO", "OOO", 'O', Items.coin_silver, 'P', Items.purse_bag_empty});
        this.addRecipe(new ItemStack(Items.purse_bag_16s, 1), new Object[] {"OOO", "OPO", "OOO", 'O', Items.coin_silver, 'P', Items.purse_bag_8s});
        this.addRecipe(new ItemStack(Items.purse_bag_24s, 1), new Object[] {"OOO", "OPO", "OOO", 'O', Items.coin_silver, 'P', Items.purse_bag_16s});
        this.addRecipe(new ItemStack(Items.purse_bag_32s, 1), new Object[] {"OOO", "OPO", "OOO", 'O', Items.coin_silver, 'P', Items.purse_bag_24s});
        
        this.addShapelessRecipe(new ItemStack(Items.coin_silver, 8), new Object[] {Items.purse_bag_8s});
        this.addShapelessRecipe(new ItemStack(Items.coin_silver, 16), new Object[] {Items.purse_bag_16s});
        this.addShapelessRecipe(new ItemStack(Items.coin_silver, 24), new Object[] {Items.purse_bag_24s});
        this.addShapelessRecipe(new ItemStack(Items.coin_silver, 32), new Object[] {Items.purse_bag_32s});
        
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_16s, 1), new Object[] {Items.purse_bag_8s, Items.purse_bag_8s});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_24s, 1), new Object[] {Items.purse_bag_8s, Items.purse_bag_8s, Items.purse_bag_8s});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_32s, 1), new Object[] {Items.purse_bag_8s, Items.purse_bag_8s, Items.purse_bag_8s, Items.purse_bag_8s});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_24s, 1), new Object[] {Items.purse_bag_8s, Items.purse_bag_16s});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_32s, 1), new Object[] {Items.purse_bag_8s, Items.purse_bag_8s, Items.purse_bag_16s});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_32s, 1), new Object[] {Items.purse_bag_16s, Items.purse_bag_16s});
        this.addShapelessRecipe(new ItemStack(Items.purse_bag_32s, 1), new Object[] {Items.purse_bag_8s, Items.purse_bag_24s});
