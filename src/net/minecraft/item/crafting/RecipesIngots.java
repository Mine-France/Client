...
public class RecipesIngots
{
    ...
    {
        this.recipeItems = new Object[][] {{Blocks.gold_block, new ItemStack(Items.gold_ingot, 9)}, {Blocks.iron_block, new ItemStack(Items.iron_ingot, 9)}, {Blocks.diamond_block, new ItemStack(Items.diamond, 9)}, {Blocks.emerald_block, new ItemStack(Items.emerald, 9)}, {Blocks.lapis_block, new ItemStack(Items.dye, 9, 4)}, {Blocks.redstone_block, new ItemStack(Items.redstone, 9)}, {Blocks.coal_block, new ItemStack(Items.coal, 9, 0)}, {Blocks.hay_block, new ItemStack(Items.wheat, 9)}, {Blocks.argent_block, new ItemStack(Items.argent_ingot, 9)}, {Blocks.cuivre_block, new ItemStack(Items.cuivre_ingot, 9)}, {Blocks.cinabre_block, new ItemStack(Items.cinabre, 9)}, {Blocks.bournonite_block, new ItemStack(Items.bournonite_ingot, 9)}, {Blocks.azurite_block, new ItemStack(Items.azurite, 9)},};
    }
