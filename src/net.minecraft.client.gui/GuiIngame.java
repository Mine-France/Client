...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        {
            this.drawPlayerOnGui(this.mc, 26, this.mc.displayHeight - this.mc.displayHeight + 65, 28, -0.0F, 0.0F);
        }
    ...
    private static void drawPlayerOnGui(Minecraft par0Minecraft, int par1, int par2, int par3, float par4, float par5)
    {
        ...
        float var9 = par0Minecraft.thePlayer.rotationYawHead;
        ...
        par0Minecraft.thePlayer.rotationYawHead = var9;
        GL11.glPopMatrix();
        RenderHelper.disableStandardItemLighting();
        GL11.glDisable(GL12.GL_RESCALE_NORMAL);
